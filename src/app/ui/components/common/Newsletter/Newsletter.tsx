    ...
    return (
        <form>
            <div className="relative flex w-full shrink-0 rounded-xl">
                ...
                />
                <div className="absolute w-full left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 text-white">
                    <div className="flex flex-col items-center justify-center gap-[10px]">
                        <h1 className="text-[48px] leading-[57px]">Stay up-to-date on our deals.</h1>
